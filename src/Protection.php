...
****************************************************************************/
    ...
    {
        if ($this->encrypted)
            $s = Helper::RC4($this->_objectkey($this->n), $s);
        parent::_putstream($s);
    }
    ...
    */
    function _Ovalue($user_pass, $owner_pass)
    {
        ...
        return Helper::RC4($owner_RC4_key, $user_pass);
    }
    ...
    */
    function _Uvalue()
    {
        return Helper::RC4($this->encryption_key, $this->padding);
    }
